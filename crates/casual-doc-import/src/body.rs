...
use casual_doc_model::v1::{
    ...
    SdtControlKind, SdtProperties, SectionBoundary, SectionColumns, SectionId, SectionType,
    StyleKind, Tab, TabAlignment, TabLeader, TabStop, TableLayout, TableOverlap, TextBox,
