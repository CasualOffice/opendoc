...
| P1D-004 | Incremental relayout + virtualized scroll | Claude Code | In progress | Dirty tracking + stabilization halt; O(neighborhood) per edit. P1D-004a (prefix reuse) done; P1D-004b (suffix stabilization halt) + virtualized scroll next. |
