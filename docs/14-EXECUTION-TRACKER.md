...
| P1B-005c | Writer notes/headers/comments | Claude Code | Next | footnotes/endnotes, headers/footers (+ section refs, N parts w/ per-part r:ids), comments.xml — contracts mapped (agent workflow). Part-own images/hyperlinks inside these deferred to the media path. |
