...
| P1A-008 | Normalized schema v1 design | Claude Code | Accepted | `38-NORMALIZED-SCHEMA-V1-DESIGN.md` accepted 2026-07-24. Unblocks importer content-mapping (doc 32 slices 5–7). Implementation in progress in `casual-doc-model`. |
