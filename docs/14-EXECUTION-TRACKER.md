...
| P1A-008 | Normalized schema v1 design | Claude Code | Designing | `38-NORMALIZED-SCHEMA-V1-DESIGN.md`; proposed. Gates importer content-mapping code (doc 32 slices 5–7). Needs owner acceptance; then implement in `casual-doc-model` with v0→v1 migration goldens. |
