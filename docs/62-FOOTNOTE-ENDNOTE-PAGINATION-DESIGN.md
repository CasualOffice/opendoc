...
Implementation note: the sixth Slice D increment adds
`fixtures/generated/note-references.docx`, generated by
`crates/casual-doc-ooxml/examples/generate_fixtures.rs`, with main-document
relationships to both `word/footnotes.xml` and `word/endnotes.xml`. The package
