...
const FORMAT_SUPPORT = [
  ...
  {
    format: "ODT",
    note: "ODF 1.2–1.4 package admission is complete. The bounded importer currently maps core paragraphs, headings, spans, spaces, tabs, and line breaks; styles, complex structures, export, registry wiring, and browser support remain in progress.",
    validation: "full",
    import: "partial",
    export: "none",
    host: "none",
