...
const FORMAT_SUPPORT = [
  ...
  {
    format: "ODT",
    note: "ODF 1.2–1.4 admission plus generic WASM/browser Open and Save are implemented. Import/export and therefore host support remain partial: core text, safe links, bookmarks, bounded direct/named styles, and nested bullet/number lists map through the normalized model and matching writer. Style defaults/broader properties, advanced list continuation/item overrides and label layout, tables, notes, media, metadata, edit-tolerant preservation, and conformance remain in progress.",
    validation: "full",
    import: "partial",
    export: "partial",
    host: "partial",
